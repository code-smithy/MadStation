...
Phase 6 has started with persistence/recovery foundations: configurable snapshot cadence/path, periodic snapshot persistence during ticks, startup restore from snapshot, and snapshot-related runtime status fields. See `docs/phase6/PHASE6_SPLIT_PLAN.md` and `docs/phase6/USER_SIDE_TESTING.md`.
